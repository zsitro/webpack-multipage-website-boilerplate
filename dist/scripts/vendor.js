...
/*
  ...
  Updated by Jake Gully, yadda.co.uk 2014
...
;( function($, window, document, undefined) {
  ...
  $.fn.imagelightbox = function( options ) {
    ...
    var targets = $([]),
      ...
      loadImage = function( direction ) {
        ...
        if (image.length) {
          ...
          if (isCssTransitionSupport) {
            ...
            params.left = parseInt(image.css( 'left' ), 100) + 100 * direction + 'px';
          }
          image.animate( params, options.animationSpeed, function(){ removeImage(); });
          swipeDiff = 0;
        }

        // If no image found then quit
        if (!target.attr( 'href' )) {
          quitLightbox();
          return false;
        }
        ...
        setTimeout( function() {
          ...
          .load( function() {
            ...
            if( isCssTransitionSupport ) {
              ...
              var imagePosLeft = parseInt(image.css( 'left' ), 10);
          ...
          .on('touchstart pointerdown MSPointerDown', function(e) {
            ...
            if(isCssTransitionSupport) imagePosLeft = parseInt(image.css('left'), 10);
      ...
      showArrows = function () {
        var prev_btn = $('#imagelightboxprev'),
            next_btn = $('#imagelightboxnext');
      ...
      removeArrows = function () {
        $('#imagelightboxprev, #imagelightboxnext').remove();
      },

      showCloseButton = function () {
        var close_btn = $('#imagelightboxclose');
      ...
      showMask = function () {
        var mask = $('#imagelightboxmask');

        if (mask.length > 0) {
          mask.show();
        } else {
          $('<div/>')
            .attr('id', 'imagelightboxmask')
            .appendTo('body');
        }
      },
